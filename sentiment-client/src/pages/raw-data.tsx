  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh]">
      ...
      <p className="text-slate-500 mt-2">
        Upload a CSV file to begin analyzing sentiment data
      </p>
    </div>
  );
};
...
export default function RawData() {
  ...
  const filteredPosts =
    selectedFileId === "all"
      ? postsArray
      : postsArray.filter((post) => post.fileId === parseInt(selectedFileId));
        ...
        <div className="relative p-6 z-10">
          <div>
            ...
            <p className="mt-3 text-base text-slate-700 leading-relaxed">
              This advanced analysis system examines bilingual (English and
              Filipino) social media data during natural disasters, providing
              real-time insights into public emotional responses. The data helps
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <div className="bg-white/80 backdrop-blur-sm p-5 rounded-xl shadow-sm border border-slate-200/60">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                respond to public needs in real-time through advanced sentiment
                analysis.
              </p>
            </div>
      ...
      <Card className="bg-white/90 rounded-xl shadow-lg border border-slate-200/60 overflow-hidden">
        <CardHeader className="p-5 bg-gradient-to-r from-slate-50 to-indigo-50/50">
          <div className="flex items-center gap-2">
            ...
            <div>
              <CardTitle className="text-lg bg-gradient-to-r from-indigo-700 to-blue-600 bg-clip-text text-transparent">
                Data Filters
              </CardTitle>
