...
import { FacebookComment, FacebookPost } from "../../lib/api";
import {
        ...
        >
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-slate-500">
              ...
              {post.disasterType && (
                <div className="flex items-center gap-1">
                  <div
                    ...
                    style={{
                      backgroundColor: getDisasterTypeColor(post.disasterType),
                    }}
                  ></div>
              ...
              <div className="flex items-center gap-1">
                <span className="text-xs px-1.5 py-0.5 rounded bg-blue-50 text-blue-600 underline">
                  <a
                    href={post.permalink_url as string}
                    target="_blank"
