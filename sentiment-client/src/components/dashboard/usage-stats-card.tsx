  ...
  return (
    <Card className="overflow-hidden shadow-lg border-none hover:shadow-xl transition-all duration-300 group">
      ...
      >
        {/* Gradient background */}
        <div
          className={`absolute inset-0 bg-gradient-to-br from-green-600 to-teal-600 opacity-90`}
        ></div>
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="flex justify-between items-start mb-4">
                <div
                  className={`w-12 h-12 rounded-full bg-white/20 flex items-center justify-center shadow-lg`}
                >
